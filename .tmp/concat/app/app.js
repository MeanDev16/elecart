...
angular.module('shopnxApp')
  .controller('SettingsCtrl', ["$scope", "User", "Auth", "Settings", "toastr", function ($scope, User, Auth, Settings, toastr) {
    $scope.errors = {};
...
angular.module('shopnxApp')
  .controller('AdminCtrl', ["$scope", "PaymentMethods", "Settings", "toastr", function ($scope, PaymentMethods, Settings, toastr) {
...
angular.module('shopnxApp')
  .controller('InventoryCtrl', ["$scope", "socket", "Product", "Modal", "Settings", function ($scope, socket, Product, Modal, Settings) {
    $scope.products = [];
...
// For Price slider
    ...
    $scope.resetPriceRange = function(){
      $scope.priceSlider = {
          ...
          min: 0,
          max: 130000,
          options: {ceil: 130000, floor: 0, onEnd: $scope.filter, translate : function(value){
...
angular.module('shopnxApp')
  .config(["$stateProvider", function ($stateProvider) {
    $stateProvider
      .state('main', {
        title: 'eCommerce Fashion Store Using AngularJS',
        url: '/',
...
angular.module('shopnxApp')
  .controller('ProductCtrl', ["$scope", "socket", "Product", "Category", "Brand", "Feature", "Modal", "toastr", "$loading", "Settings", function ($scope, socket, Product, Category, Brand, Feature, Modal, toastr, $loading, Settings) {
    var cols = [
...
angular.module('shopnxApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/account/signup/signup.html',
    "<div class=container><div class=row><div class=col-md-3></div><div class=col-md-6><div class=box><h1>New account</h1><p class=lead>Not our registered customer yet?</p><p>With registration with us new world of fashion, fantastic discounts and much more opens to you! The whole process will not take you more than a minute!</p><p class=text-muted>If you have any questions, please feel free to <a href=/contact>contact us</a>, our customer service center is working for you 24/7.</p><hr><form ng-submit=register(form) novalidate name=form><div class=form-group ng-class=\"{ 'has-success': form.name.$valid && submitted,\n" +
  ...
  $templateCache.put('app/contact/contact.html',
    ...
    "_________________________________________________________ --><div class=\"panel panel-default sidebar-menu\"><div class=panel-heading><h3 class=panel-title>Pages</h3></div><div class=panel-body><ul class=\"nav nav-pills nav-stacked\"><li><a href=#>Text page</a></li><li><a href=#>Contact page</a></li><li><a href=#>FAQ</a></li></ul></div></div><!-- *** PAGES MENU END *** --><div class=banner><a href=#><img src=/assets/img/banner.jpg alt=\"sales 2014\" class=img-responsive></a></div></div><div class=col-md-9><div class=box id=contact><h1>Contact</h1><p class=lead>Are you curious about something? Do you have some kind of problem with our products?</p><p>Please feel free to contact us, our customer service center is working for you 24/7.</p><hr><div class=row><div class=col-sm-4><h3><i class=\"fa fa-map-marker\"></i> Address</h3><p>13/25 New Avenue<br>New Heaven<br>45Y 73J<br>England<br><strong>Great Britain</strong></p></div><!-- /.col-sm-4 --><div class=col-sm-4><h3><i class=\"fa fa-phone\"></i> Call center</h3><p class=text-muted>This number is toll free if calling from Great Britain otherwise we advise you to use the electronic form of communication.</p><p><strong>+33 555 444 333</strong></p></div><!-- /.col-sm-4 --><div class=col-sm-4><h3><i class=\"fa fa-envelope\"></i> Electronic support</h3><p class=text-muted>Please feel free to write an email to us or to use our electronic ticketing system.</p><ul><li><strong><a href=mailto:>info@fakeemail.com</a></strong></li><li><strong><a href=#>Ticketio</a></strong> - our ticketing support platform</li></ul></div><!-- /.col-sm-4 --></div><!-- /.row --><hr><div id=map></div><hr><h2>Contact form</h2><form><div class=row><div class=col-sm-6><div class=form-group><label for=firstname>Firstname</label><input class=form-control id=firstname></div></div><div class=col-sm-6><div class=form-group><label for=lastname>Lastname</label><input class=form-control id=lastname></div></div><div class=col-sm-6><div class=form-group><label for=email>Email</label><input class=form-control id=email></div></div><div class=col-sm-6><div class=form-group><label for=subject>Subject</label><input class=form-control id=subject></div></div><div class=col-sm-12><div class=form-group><label for=message>Message</label><textarea id=message class=form-control></textarea></div></div><div class=\"col-sm-12 text-center\"><button type=submit class=\"btn btn-primary\"><i class=\"fa fa-envelope-o\"></i> Send message</button></div></div><!-- /.row --></form></div></div><!-- /.col-md-9 -->"
  );


  $templateCache.put('app/country/country.html',
    "<crud-table api=Country cols='[{\"name\":\"text\"},{\"dial_code\":\"text\"},{\"code\":\"text\"},{\"active\":\"boolean\"}]'></crud-table>"
  );
  ...
  $templateCache.put('app/main/main.html',
    "<link rel=stylesheet href=bower_components/angular-loading/angular-loading.css><div class=col-md-12><ul class=breadcrumb><li><a ui-sref=main href=\"\">Home</a></li><li ng-repeat=\"b in breadcrumb.items | reverse\"><a href=/ ng-if=!$last>{{b.name}}</a> <span ng-if=$last>{{b.name}}</span></li></ul></div><div class=col-md-3><div class=\"panel panel-default sidebar-menu\"><div class=panel-heading><h3 class=panel-title>Price Range <a class=\"btn btn-xs btn-danger pull-right\" href=\"\" ng-click=resetPriceRange();><i class=\"fa fa-times-circle\"></i> Reset</a></h3></div><div class=panel-body><form><div class=form-group><rzslider rz-slider-model=priceSlider.min rz-slider-high=priceSlider.max rz-slider-options=priceSlider.options></rzslider>₹​<strong>{{priceSlider.min}}</strong> &nbsp;-&nbsp; ₹​<strong>{{priceSlider.max}}</strong></div></form></div></div><div class=\"panel panel-default sidebar-menu\"><div class=panel-heading><h3 class=panel-title>Brands<div class=nav-search id=nav-search><span class=input-icon><input placeholder=\"Filter Brands ...\" class=nav-search-input ng-model=filterBrand autocomplete=off autofocus style=width:100%> <i class=\"search-icon fa fa-search nav-search-icon\"></i></span></div></h3></div><div class=\"panel-body brand-filter-panel\"><form><div class=form-group><div class=checkbox ng-repeat=\"b in brands | filter:filterBrand\"><label><input type=checkbox value={{b.name}} checklist-model=fl.brands checklist-value=b ng-click=filter();> {{b.name}}<span>&nbsp;</span></label></div></div><a class=\"btn btn-xs btn-warning pull-right\" href=\"\" ng-repeat=\"b in fl.brands\" ng-click=removeBrand(b); style=\"margin:0 0 5px 5px\"><i class=\"fa fa-times-circle\"></i> {{b.name}}</a></form></div></div><div class=\"panel panel-default sidebar-menu\"><div class=panel-heading><h3 class=panel-title>Features<div class=nav-search id=nav-search><span class=input-icon><input placeholder=\"Filter Features ...\" class=nav-search-input ng-model=filterFeature autocomplete=off autofocus style=width:100%> <i class=\"search-icon fa fa-search nav-search-icon\"></i></span></div></h3></div><div class=panel-body><form><div class=form-group><div ng-repeat=\"k in features | filter:filterFeature\"><h4>{{k.key}}</h4><div class=checkbox ng-repeat=\"f in k.v\"><label><input type=checkbox value={{f}} checklist-model=fl.features[k.key] checklist-value=f ng-click=filter();> {{f}}<span>&nbsp;</span></label></div></div></div></form></div></div></div><div class=col-md-9><div class=\"box info-bar\"><div class=row><div class=\"col-sm-12 col-md-5 products-showing\">Showing {{products.items.length}} products of {{products.count}} in: ₹​<strong>{{priceSlider.min}}</strong> &nbsp;-&nbsp; ₹​<strong>{{priceSlider.max}}</strong></div><div class=\"col-sm-12 col-md-7 text-right products-number-sort\"><div class=row><form class=form-inline><div class=\"col-md-12 col-sm-12\"><div class=products-number><strong>Sort</strong><div class=btn-group><a href=\"\" ng-repeat=\"o in sortOptions\" ng-class=\"{active : o.val==products.sort}\" class=\"btn btn-default btn-sm btn-primary\" ng-click=sortNow(o.val);>{{o.name}}</a></div></div></div></form></div></div><div class=\"col-sm-12 col-md-8 products-number-sort\"><div class=products-sort-by><span ng-if=\"fl.brands.length>0\">Brands:</span> <a class=\"btn btn-xs btn-warning\" href=\"\" ng-click=removeBrand(b); ng-repeat=\"b in fl.brands\" style=margin-left:5px><i class=\"fa fa-times-circle\"></i> {{b.name}}</a> <a ng-if=\"fl.categories.length>0\" class=\"btn btn-xs btn-warning\" href=\"\" ng-click=removeCategory(); style=margin-left:5px><i class=\"fa fa-times-circle\"></i>{{fl.categories[0].name}}</a> <span ng-repeat=\"features in fl.features\"><a ng-if=features ng-click=removeFeatures(features); ng-repeat=\"f in features\" class=\"btn btn-xs btn-warning\" href=\"\" style=margin-left:5px>{{f}}</a> </span><!-- <select ng-model=\"products.brand\"  ng-change=\"navigate('Brand',products.brand);\" ng-options=\"b.name for b in brands track by b._id\" class=\"pull-right\">\n" +
    "                                      <option value=\"\">All Brands</option>\n" +
    "                                  </select> --></div></div></div></div><div infinite-scroll=scroll() infinite-scroll-disabled=products.busy infinite-scroll-distance=1><div class=\"row products\" dw-loading=products dw-loading-options=\"{text: ''}\"><div class=box ng-if=\"products.items.length==0 && !products.busy\"><div class=row><div class=col-sm-12><h3>No product found. Try removing some filters.</h3></div></div></div><div class=\"col-md-4 col-sm-6\" ng-repeat=\"product in products.items\"><div class=product><div class=flip-container><div class=flipper><div class=front><a ui-sref=\"productDetail({id:product._id, slug:product.slug})\"><img ng-src=/assets/mobiles/{{product.variants[0].image}} err-src=/assets/images/photo.png alt={{product.name}} class=img-responsive></a></div><div class=back><a ui-sref=\"productDetail({id:product._id, slug:product.slug})\"><img ng-src=/assets/mobiles/{{product.variants[0].image}} err-src=/assets/images/photo.png alt={{product.name}} class=img-responsive></a></div></div></div><a ui-sref=\"productDetail({id:product._id, slug:product.slug})\" class=invisible><img src=/assets/mobiles/{{product.variants[0].image}} alt=\"\" class=img-responsive></a><div class=\"text text-center\"><h3><a ui-sref=\"productDetail({id:product._id, slug:product.slug})\">{{product.name}} - {{product.variants[0].size}}</a></h3><p class=price><del ng-if=\"product.variants[0].price!=product.variants[0].mrp\">{{product.variants[0].mrp | currency : '₹​'}}</del> {{product.variants[0].price | currency : '₹​'}}</p><p class=buttons></p><div class=btn-group><a ui-sref=\"productDetail({id:product._id, slug:product.slug})\" class=\"btn btn-default\">View detail</a> <a ng-click=\"cart.addItem({sku:product._id, name:product.name, slug:product.slug, mrp:product.variants[0].mrp, price:product.variants[0].price, weight:product.variants[0].weight}, -1)\" ng-hide=checkCart(product._id) class=\"btn btn-info\">-</a> <a ng-hide=checkCart(product._id) class=\"btn btn-info\">{{getQuantity(product._id);}}</a> <a ng-click=\"cart.addItem({sku:product._id, name:product.name, slug:product.slug, mrp:product.variants[0].mrp, price:product.variants[0].price, weight:product.variants[0].weight}, +1)\" ng-hide=checkCart(product._id) class=\"btn btn-info\">+</a></div><a ng-click=\"cart.addItem({sku:product._id, name:product.name, slug:product.slug, mrp:product.variants[0].mrp, price:product.variants[0].price, quantity:1, image:product.variants[0].image,category:product.category, size:product.variants[0].size, weight:product.variants[0].weight} ,true);\" ng-show=checkCart(product._id) class=\"btn btn-primary\"><i class=\"fa fa-shopping-cart\"></i>Add to cart</a><p></p></div><!-- /.text --></div><!-- /.product --></div><!-- /.col-md-4 --></div><!-- /.products --></div><!-- /.col-md-9 --></div><!-- /just to enable infinite scroll -->"
  );


  $templateCache.put('app/main/product-details.html',
    "<div class=container><div class=row><div class=\"col-sm-12 text-center\"><ol class=breadcrumb><li><a ui-sref=main href=\"\">Home</a></li><li ng-repeat=\"b in breadcrumb.items | reverse\"><a href=/ ng-if=!$last>{{b.name}}</a> <span ng-if=$last>{{b.name}}</span></li></ol></div><hr class=clearfix></div></div><div class=container><div class=row><div class=col-md-3><!-- *** MENUS AND FILTERS ***\n" +
    "_________________________________________________________ --><div class=\"panel panel-default sidebar-menu\"><div class=panel-heading><h3 class=panel-title>Categories</h3></div><div class=panel-body><ul class=\"nav nav-pills nav-stacked category-menu\"><li ng-repeat=\"p in categories\"><a href=category.html>{{p.name}} <span class=\"badge pull-right\">42</span></a><ul><li ng-repeat=\"c in p.sub_categories\"><a href=/Category/{{c.slug}}/{{c._id}}>{{c.name}}</a></li></ul></li></ul></div></div><!-- *** MENUS AND FILTERS END *** --><div class=banner><a href=#><img src=/assets/img/banner.jpg alt=\"sales 2015\" class=img-responsive></a></div></div><div class=col-md-9><div class=row id=productMain><div class=col-sm-6><div id=mainImage><img src=/assets/mobiles/{{product.variants[0].image}} err-src=/assets/images/photo.png alt={{product.name}} class=img-responsive></div><div class=\"ribbon sale\"><div class=theribbon>SALE</div><div class=ribbon-background></div></div><!-- /.ribbon --><div class=\"ribbon new\"><div class=theribbon>NEW</div><div class=ribbon-background></div></div><!-- /.ribbon --></div><div class=col-sm-6><div class=box><h1 class=text-center>{{product.name}} (Size: {{product.variants[i].size}})</h1><p class=goToDescription><a href=#details class=scroll-to>Scroll to product details, material & care and sizing</a></p><p class=price><del class=text-muted ng-if=\"product.variants[0].price!=product.variants[0].mrp\">₹​{{product.variants[i].mrp}}</del>&nbsp;₹​{{product.variants[i].price}}</p><div class=\"text-center buttons\"><div class=btn-group><a ui-sref=\"productDetail({id:product._id, slug:product.slug})\" class=\"btn btn-default\">View detail</a> <a ng-click=\"cart.addItem({sku:product._id, name:product.name, slug:product.slug, mrp:product.variants[0].mrp, price:product.variants[0].price, weight:product.variants[0].weight}, -1)\" ng-hide=checkCart(product._id) class=\"btn btn-info\">-</a> <a ng-hide=checkCart(product._id) class=\"btn btn-info\">{{getQuantity(product._id);}}</a> <a ng-click=\"cart.addItem({sku:product._id, name:product.name, slug:product.slug, mrp:product.variants[0].mrp, price:product.variants[0].price, weight:product.variants[0].weight}, +1)\" ng-hide=checkCart(product._id) class=\"btn btn-info\">+</a></div><a ng-click=\"cart.addItem({sku:product._id, name:product.name, slug:product.slug, mrp:product.variants[0].mrp, price:product.variants[0].price, quantity:1, image:product.variants[0].image,category:product.category, size:product.variants[0].size, weight:product.variants[0].weight} ,true);\" ng-show=checkCart(product._id) class=\"btn btn-primary\"><i class=\"fa fa-shopping-cart\"></i>Add to cart</a></div></div><div class=row id=thumbs><div class=col-xs-4 ng-repeat=\"v in product.variants\" ng-click=changeIndex($index); ng-if=\"v.size!=product.variants[i].size\"><a href=\"\" class=thumb><img src=/assets/mobiles/{{v.image}} err-src=/assets/images/photo.png alt={{product.name}} class=img-responsive> {{product.name}} (Size: {{v.size}})<p class=price><del class=text-muted ng-if=\"v.price!=v.mrp\">₹​{{v.mrp}}</del>&nbsp;₹​{{v.price}}</p></a></div></div></div></div><div class=box id=details><p></p><div ng-if=product.info><h4>Product details</h4><p>{{product.info}}</p></div><div ng-if=product.brand><h4>Brand</h4><ul><li><a href=/Brand/{{product.brand.name}}/{{product.brand._id}}>{{product.brand.name}}</a></li></ul></div><div ng-if=product.category><h4>Category</h4><ul><li><a href=/Category/{{product.category.slug}}/{{product.category._id}}>{{product.category.name}}</a></li></ul></div><div ng-if=product.variants[i]><h4>Weight</h4><ul><li>{{product.variants[i].weight}}</li></ul></div><div ng-if=\"product.features.length>0\"><h4>Features</h4><ul><li ng-repeat=\"f in product.features\">{{f.key}} : {{f.val}}</li></ul></div><div ng-if=\"product.keyFeatures.length>0\"><h4>Key Features</h4><ul><li ng-repeat=\"f in product.keyFeatures\">{{f}}</li></ul></div><blockquote><p>Define style this season with Armani's new range of trendy tops, crafted with intricate details. Create a chic statement look by teaming this lace number with skinny jeans and pumps.</p></blockquote><hr><div class=social><h4>Show it to your friends</h4><p><a href=https://www.facebook.com/codenx2 class=\"external facebook\" data-animate-hover=pulse><i class=\"fa fa-facebook\"></i></a> <a href=# class=\"external gplus\" data-animate-hover=pulse><i class=\"fa fa-google-plus\"></i></a> <a href=https://twitter.com/itswadesh class=\"external twitter\" data-animate-hover=pulse><i class=\"fa fa-twitter\"></i></a> <a href=# class=email data-animate-hover=pulse><i class=\"fa fa-envelope\"></i></a></p></div></div></div></div></div>"
  );


  $templateCache.put('app/order/order.html',
    "<div class=col-md-12><div class=box><div class=row><div class=col-md-12><h1>Orders History</h1><h3 class=\"bg-info well text-center\">Total Spent: {{orders.total | currency:'&#8377;'}}</h3><div class=\"panel panel-primary\" ng-repeat=\"o in orders | orderBy : 'orderDate' : 'reverse'\"><div class=panel-heading><div class=panel-title><button class=\"btn btn-warning\">{{o.orderNo}}</button>&nbsp;{{o.orderDate | amCalendar}}<div class=\"col-sm-3 pull-right\" ng-if=isAdmin()><select ng-model=o.status ng-options=\"i.name for i in orderStatusLov track by i.val\" ng-change=changeStatus(o) class=form-control></select></div></div></div><div class=panel-body><table class=table><tbody><tr ng-repeat=\"i in o.items\"><td><img ng-src=/assets/clothing/{{i.image}} err-src=/assets/images/photo.png width=100px></td><td>{{i.name}}<br><span class=text-muted>Qty: {{i.quantity}}</span><br><span class=text-muted>Packing/Size: {{i.size}}</span><br><span class=text-muted>Unit Price: {{i.price | currency:'&#8377;'}}</span></td><td><span class=text-muted>= {{i.quantity * i.price | currency:'&#8377;'}}</span></td></tr><tr class=\"well text-muted\"><td colspan=1 class=text-right></td><td class=text-right>Shipping Charge:</td><td colspan=1>{{o.shipping.charge | currency:'&#8377;'}}</td></tr><tr class=\"well text-muted\"><td colspan=1 class=text-right></td><td class=text-right>Coupon:</td><td colspan=1>{{o.shipping.couponAmount | currency:'&#8377;'}}</td></tr><tr class=well><td colspan=1 class=text-right></td><td class=text-right>Order Total:</td><td colspan=1>{{o.shipping.total | currency:'&#8377;'}}</td></tr></tbody></table></div></div></div></div></div></div>"
  );


  $templateCache.put('app/paymentMethod/paymentMethod.html',
    "<div class=col-md-12><crud-table api=PaymentMethod cols='[{\"name\":\"text\"},{\"email\":\"text\"},{\"active\":\"boolean\"}]' nodelete=true noadd=true disabledcolumn=name></crud-table></div><!-- <div class=\"row\">\n" +
  ...
  $templateCache.put('components/navbar/navbar.html',
    ...
    "_________________________________________________________ --><div id=top><div class=container><div class=\"col-md-6 offer\" data-animate=fadeInDown><a href=# class=\"btn btn-success btn-sm\" data-animate-hover=shake>Offer of the day</a> <a href=#>Get flat 35% off on orders over $50!</a></div><div class=col-md-6 data-animate=fadeInDown><ul class=menu><li ng-hide=isLoggedIn() ng-class=\"{active: isActive('/signup')}\"><a href=/signup>Sign up</a></li><li ng-hide=isLoggedIn() ng-class=\"{active: isActive('/login')}\"><a href=/login>Login</a></li><li ng-show=isLoggedIn()><a href=\"\">Hello {{ getCurrentUser().name }}</a></li><li class=dropdown ng-show=isLoggedIn() dropdown=\"\"><span uib-dropdown on-toggle=toggled(open)><a href uib-dropdown-toggle><i class=\"fa fa-dashboard\">&nbsp;</i>Dashboard<b class=caret></b></a><ul class=dropdown-menu uib-dropdown-menu role=menu><li ng-show=isAdmin() ng-class=\"{active: isActive('/product')}\"><a href=/product><i class=\"fa fa-truck\">&nbsp;</i>Products</a></li><li ng-show=isAdmin() ng-class=\"{active: isActive('/category')}\"><a href=/category><i class=\"fa fa-ticket\">&nbsp;</i>Categories</a></li><li ng-show=isAdmin() ng-class=\"{active: isActive('/brand')}\"><a href=/brand><i class=\"fa fa-tag\">&nbsp;</i>Brands</a></li><li ng-show=isAdmin() ng-class=\"{active: isActive('/feature')}\"><a href=/feature><i class=\"fa fa-tag\">&nbsp;</i>Features</a></li><li ng-show=isAdmin() ng-class=\"{active: isActive('/coupon')}\"><a href=/coupon><i class=\"fa fa-tag\">&nbsp;</i>Coupons</a></li><li ng-show=isLoggedIn() ng-class=\"{active: isActive('/order')}\"><a href=/order><i class=\"fa fa-road\">&nbsp;</i>Orders</a></li><li class=divider></li><li ng-show=isLoggedIn() ng-class=\"{active: isActive('/settings')}\"><a href=/settings><i class=\"fa fa-user\">&nbsp;</i>Change Password</a></li><li ng-show=isAdmin() ng-class=\"{active: isActive('/customer')}\"><a href=/customer><i class=\"fa fa-user\">&nbsp;</i>Customers</a></li><li ng-show=isAdmin() ng-class=\"{active: isActive('/paymentMethod')}\"><a href=/paymentMethod><i class=\"fa fa-wrench\">&nbsp;</i>Payment Method</a></li><li ng-show=isAdmin() ng-class=\"{active: isActive('/shipping')}\"><a href=/shipping><i class=\"fa fa-wrench\">&nbsp;</i>Shipping Settings</a></li><!-- <li ng-show=\"isAdmin()\" ng-class=\"{active: isActive('/country')}\">\n" +
    "                    <a href=\"/country\"><i class=\"fa fa-wrench\">&nbsp;</i>Country</a>\n" +
    "                  </li> --><li ng-show=isLoggedIn() ng-class=\"{active: isActive('/logout')}\"><a href=\"\" ng-click=logout()><i class=\"fa fa-sign-out\">&nbsp;</i>Logout</a></li><li class=divider></li></ul></span></li><li><a href=/contact>Contact</a></li><li><a href=/documentation>Documentation</a></li></ul></div></div><div class=\"modal fade\" id=login-modal tabindex=-1 role=dialog aria-labelledby=Login aria-hidden=true><div class=\"modal-dialog modal-sm\"><div class=modal-content><div class=modal-header><button type=button class=close data-dismiss=modal aria-hidden=true>&times;</button><h4 class=modal-title id=Login>Customer login</h4></div><div class=modal-body><form action=customer-orders.html method=post><div class=form-group><input class=form-control id=email-modal placeholder=email></div><div class=form-group><input type=password class=form-control id=password-modal placeholder=password></div><p class=text-center><button class=\"btn btn-primary\"><i class=\"fa fa-sign-in\"></i> Log in</button></p></form><p class=\"text-center text-muted\">Not registered yet?</p><p class=\"text-center text-muted\"><a href=register.html><strong>Register now</strong></a>! It is easy and done in 1&nbsp;minute and gives you access to special discounts and much more!</p></div></div></div></div></div><!-- *** TOP BAR END *** --><!-- *** NAVBAR ***\n" +
    "_________________________________________________________ --><div class=\"navbar navbar-default yamm\" role=navigation id=navbar><div class=container><div class=col-md-12><div class=navbar-header><a class=\"navbar-brand home\" href=index.html data-animate-hover=bounce><!-- <img src=\"/assets/img/logo.gif\" alt=\"CodeNx logo\" class=\"hidden-xs\">\n" +
    "                <img src=\"/assets/img/logo.gif\" alt=\"CodeNx logo\" class=\"visible-xs\"> --> <img src=/assets/img/appy.png> <span class=sr-only>ElectShoppee - go to homepage</span></a><div class=navbar-buttons><button type=button class=navbar-toggle data-toggle=collapse data-target=#navigation ng-click=\"isCollapsed1 = !isCollapsed1\"><span class=sr-only>Toggle navigation</span> <i class=\"fa fa-align-justify\"></i></button> <button type=button class=navbar-toggle data-toggle=collapse data-target=#search><span class=sr-only>Toggle search</span> <i class=\"fa fa-search\"></i></button> <a class=\"btn btn-default navbar-toggle\" ng-click=\"openCart(cart,'lg');\" href=\"\"><i class=\"fa fa-shopping-cart\">&nbsp;</i> <span class=hidden-xs>Cart ({{cart.getTotalCount()}}) - {{cart.getTotalPrice() | currency:'&#8377;'}}</span></a></div></div><!--/.navbar-header --><div class=\"navbar-collapse collapse navbar-static-top megamenu\" id=navigation><div collapse=isCollapsed1 class=\"navbar-collapse collapse\" id=navbar-main2><ul class=\"nav navbar-nav navbar-left\"><li class=\"dropdown yamm-fw\" ng-repeat=\"p in categories\"><a href=# class=dropdown-toggle data-toggle=dropdown data-hover=dropdown data-delay=200>{{p.name}} <b class=caret></b></a><ul class=dropdown-menu><li><div class=yamm-content><div class=row><div class=col-lg-3 ng-repeat=\"c in p.sub_categories\"><!--  <h5>All</h5> --><ul><li><a href=/Category/{{c.slug}}/{{c._id}} ng-click=hideSubMenu();>{{c.name}}</a></li></ul></div></div></div><!-- /.yamm-content --></li></ul></li></ul></div></div><!--/.nav-collapse --><div class=navbar-buttons><div class=\"navbar-collapse collapse right\" id=basket-overview><a class=\"btn btn-primary navbar-btn\" ng-click=\"openCart(cart,'lg');\" href=\"\"><i class=\"fa fa-shopping-cart\">&nbsp;</i> <span class=hidden-sm>Cart ({{cart.getTotalCount()}}) - {{cart.getTotalPrice() | currency:'&#8377;'}}</span></a></div><!--/.nav-collapse --><div class=\"navbar-collapse collapse right\" id=search-not-mobile><button type=button class=\"btn navbar-btn btn-primary\" data-toggle=collapse data-target=#search><span class=sr-only>Toggle search</span> <i class=\"fa fa-search\"></i></button></div></div><div class=\"collapse clearfix\" id=search><form id=searchForm class=\"ng-scope ng-pristine ng-valid navbar-form\" role=search><div class=\"nav-search text-center\" id=nav-search><span class=input-icon><script type=text/ng-template id=searchTemplate.html><a><span>{{match.model.name}}</span></a></script><div class=input-group><input class=\"form-control text-left\" name=q id=q autocomplete=off placeholder=\"Search for a product, category or brand...\" ng-model=search uib-typeahead=\"p as p.name for p in globalSearch($viewValue)\" typeahead-loading=loadingLocations typeahead-no-results=noResults typeahead-template-url=searchTemplate.html typeahead-on-select=\"onSelectProduct($item, $model, $label)\" autofocus> <span class=input-group-btn><button type=submit class=\"btn btn-primary\"><i class=\"fa fa-search\"></i>Search</button></span></div></span></div></form><!-- <form class=\"navbar-form\" role=\"search\">\n" +
